...
@click.option("--templates", "-t", type=str , help="list of comma separated templates. e.g. template1,template2")
def main(fasta_file, stoichiometry, output_dir, uniform_copies,templates):
    ...
    for t in templates.split(","):
        ...
        for combo in combos:
            ...
            output_file = os.path.join(output_path,f"{job_name}.json")
